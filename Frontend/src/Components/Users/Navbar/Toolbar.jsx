...
function Toolbar() {
  return (
    <div className="font-body w-full bg-gradient-to-r from-teal-400 via-teal-500 to-gray-800 text-white py-3 px-4 flex flex-col sm:flex-row justify-between items-center text-m shadow-lg">
      ...
      <div className="flex flex-wrap items-center space-x-4">
        <div className="flex items-center space-x-1">
          ...
          <a
            ...
            className="hover:underline text-white hover:text-navy ml-[-4px]"
          >
            info@urbancad.in
          </a>
        </div>
