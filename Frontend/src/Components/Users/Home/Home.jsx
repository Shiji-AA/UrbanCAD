    ...
    <div className="relative bg-navy flex flex-col lg:flex-row items-center justify-center">
      ...
      <div className="flex items-center justify-start h-full w-full lg:w-1/2 bg-gray-800 bg-opacity-20 p-6 lg:p-12">
        <div className="text-left">
          {/* Main Headings */}
          <h1 className="pb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-purple-600 to-blue-700 text-3xl font-bold md:text-5xl leading-tight mb-4 hover:shadow-2xl transform transition duration-500 ease-in-out hover:scale-105">
            Build Your Legacy!
          </h1>
          <h3 className="text-white text-base md:text-2xl font-semibold md:leading-relaxed mb-6">
          ...
          <div className="flex flex-wrap justify-between mt-8 space-y-6 md:space-y-0 md:space-x-6 lg:space-x-12 border-t-2 border-aqua pt-6">
            {/* Feature 1 */}
            <div className="flex flex-col items-center p-6 bg-gradient-to-r from-blue-500 to-blue-500 rounded-lg shadow-lg hover:bg-aqua hover:text-white transition-all duration-300 w-40 max-w-xs h-40 shadow-md hover:shadow-2xl transform transition duration-500 ease-in-out hover:scale-105">
